...
export const RECORD_CATEGORIES = [
  ...
  },
  {
    ...
    label: 'Appliances',
    emoji: '🔌',
    description: 'Household appliances and gadgets',
    titleField: 'name',
    timelineFields: ['purchaseDate'],
    fields: [
      { key: 'name', label: 'Appliance', type: 'text', required: true },
      {
        key: 'applianceType',
        label: 'Type',
        type: 'select',
      ...
      { key: 'amount', label: 'Amount', type: 'amount' },
      { key: 'purchaseDate', label: 'Purchase date', type: 'date', relativeLabel: 'Bought' },
      { key: 'brand', label: 'Brand', type: 'text' },
      { key: 'model', label: 'Model', type: 'text' },
